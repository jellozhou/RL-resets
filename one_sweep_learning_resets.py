...
N_trials = 5 # number of trials to avg over
...
def run_sweep(trial_num, reset_rate, N, learning_rate, gamma, epsilon, n_stable_value, learning_end_condition, system_size, dimension):
    ...
    output_file_avg = f"results/trialnum_{trial_num}_resetrate_{reset_rate}_size_{N}_dimension_{dim}_systemsize_{system_size}_learningrate_{learning_rate}_gamma_{gamma}_epsilon_{epsilon}_nstable_{n_stable_value}_learningend_{learning_end_condition}_resetdecay_{reset_decay}_numepisodes_{num_episodes}.csv"
...
run_sweep(trial_num, reset_rate, N, learning_rate, gamma, epsilon, n_stable_value, learning_end_condition, system_size, dim)