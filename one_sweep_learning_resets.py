...
def run_sweep(reset_rate, N, learning_rate, gamma, epsilon, n_stable_value, qlearn_after_resets_value, boundary_type):
    print(f"Running for reset_rate={reset_rate}, size={N}, learning_rate={learning_rate}, gamma={gamma}, epsilon={epsilon}, qlearnreset={qlearn_after_resets_value}, resetdecay={reset_decay}, n_stable={n_stable_value}")
    
    output_file_avg = f"results/resetrate_{reset_rate}_size_{N}_boundary_{boundary_type}_learningrate_{learning_rate}_gamma_{gamma}_epsilon_{epsilon}_nstable_{n_stable_value}_qlearnreset_{qlearn_after_resets_value}_resetdecay_{reset_decay}_numepisodes_{num_episodes}.csv"
...
run_sweep(reset_rate, N, learning_rate, gamma, epsilon, n_stable_value, qlearn_after_resets_value, boundary_type) # actually run the sweep
